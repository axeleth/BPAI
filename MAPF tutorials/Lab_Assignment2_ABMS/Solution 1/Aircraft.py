...
class Aircraft(object):
    ...
    def plan_independent(self, nodes_dict, edges_dict, heuristics, t,ac):
        """
    ...
    def plan_prioritized(self, nodes_dict, edges_dict, heuristics, t, constraints, ac):
